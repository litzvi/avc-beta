...
public class ItemCountWithAmount extends ValueDTO {
	 ...
	 */
	public ItemCountWithAmount(Integer id, Integer version, 
		...
		super(id);
		this.itemCount = new ItemCountDTO(id, version, itemId, itemValue, itemCategory, measureUnit, containerWeight);
