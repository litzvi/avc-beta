					...
					+ "join grp.usedItems ui "
						+ "join ui.storage used_sf "
							+ "join used_sf.processItem usedPi "
								...
								+ "join UOM uom_used "
									+ "on uom_used.fromUnit = used_unit.measureUnit and uom_used.toUnit = usedItem.defaultMeasureUnit "						
...
//					+ "left join pi.item producedItem "
					+ "left join pi.storageForms sf "
						...
						+ "left join UOM uom_produced "
							+ "on uom_produced.fromUnit = producedUnit.measureUnit and uom_produced.toUnit = usedItem.defaultMeasureUnit "
