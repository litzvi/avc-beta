...
//								+ "join used_sf.unitAmount used_unit "
								+ "join UOM uom_used "
									+ "on uom_used.fromUnit = used_group.measureUnit and uom_used.toUnit = usedItem.defaultMeasureUnit "						
...
//						+ "left join sf.unitAmount producedUnit "
						+ "left join UOM uom_produced "
							+ "on uom_produced.fromUnit = produce_group.measureUnit and uom_produced.toUnit = usedItem.defaultMeasureUnit "
