...
/**
 * Subtract Row in list of inventory transactions report.
 * i.e. transaction that subtracts inventory.
 * 
 * @author zvi
 *
 */
...
public class InventoryTransactionSubtractRow extends InventoryTransactionRow {
	
	public InventoryTransactionSubtractRow(Integer id, String poCodes, String suppliers, String processName,
	...
	public AmountWithUnit getAmountSubtracted() {
		return getAmount();
	}
}
